class PickupGroceryOrderCheckOtpModal {
  bool success;
  String msg;
  Data data;

  PickupGroceryOrderCheckOtpModal({this.success, this.msg, this.data});

  PickupGroceryOrderCheckOtpModal.fromJson(Map<String, dynamic> json) {
