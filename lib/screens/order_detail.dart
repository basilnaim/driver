...
class OrderDetails extends StatefulWidget {
  ...
  OrderDetails({Key key, @required this.previousId, @required this.checkPath})
      : super(key: key);
  @override
...
class _OrderDetailsState extends State<OrderDetails> {
  ...
  bool checkPath;
  ViewSingleOrderData viewSingleOrderData;
  ...
  void getSingleOrderInfo() {
    ...
    RestClient(Retro_Api().Dio_Data())
      ...
      if (response.success) {
        ...
        setState(() {
          viewSingleOrderData = response.data;
  ...
  void orderAccept() {
    ...
    RestClient(Retro_Api().Dio_Data()).acceptOrder(body).then((response) {
      setState(() {
        _showSpinner = false;
      });
      print(response.success);
  ...
  void rejectOrder() {
    ...
    RestClient(Retro_Api().Dio_Data())
      ...
      if (response.success) {
        setState(() {
          Const.showToast('Order Rejected Successfully');
        });
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    ...
    return ModalProgressHUD(
      ...
      child: Scaffold(
        ...
        body: Visibility(
          visible: viewSingleOrderData != null,
